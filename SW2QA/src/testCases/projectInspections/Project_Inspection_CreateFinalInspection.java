...
/**
 * Test to add a <b>Final Inspection<b> for a given project.
 * 
 * @author Jesse Childress
 *
 */
public class Project_Inspection_CreateFinalInspection extends BaseTestScriptConfig {
	
	public static String INITIAL_ROLE;

	@Test
	public void createFinalInspection() {
