...
/**
 * Test to add a <b>Post Storm Inspection<b> for a given project of Inspection
 * Form Type <b>Colorado</b>.
 * 
 * @author Jesse Childress
 *
 */
public class Project_Inspection_CreatePostStormInspection_COLORADO extends BaseTestScriptConfig {

	public static String INITIAL_ROLE;

	@Test
	public void createPostStormInspection() {

		/*
		 * Login to the system
		 */
		LoginMod login = new LoginMod("Inspector");
		login.login("Colorado");
...
//		int rowIndexRandom = projectsFile.getRandomRowIndex();
		int rowIndex = projectsFile.getRowIndex("Project Name", "SQA Alpine Ski Resort");
		 ...
		 */
		InspectionQuestionsMod inspectionQuestionsModular = new InspectionQuestionsMod("Colorado",
				"Post Storm");
		...
		InspectionFindingsMod inspectionFindingsModular = new InspectionFindingsMod("Corrective Action");
...
//		inspectionFindingsModular.createAndValidateFinding();
		...
		inspectionCertificationMod.performCertOnTemplate("Colorado");
	}
