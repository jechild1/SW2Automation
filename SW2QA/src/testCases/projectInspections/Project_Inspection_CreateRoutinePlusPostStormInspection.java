...
/**
 * Test to add a <b>Routing + Post Storm Inspection<b> for a given project.
 * 
 * @author Jesse Childress
 *
 */
public class Project_Inspection_CreateRoutinePlusPostStormInspection extends BaseTestScriptConfig {

	public static String INITIAL_ROLE;

	@Test
	public void createRoutinePlusPostStormInspection() {
